    ...
    <div className="bg-white rounded-lg overflow-hidden">
      ...
      <div className="p-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center skew-x-4">
            <Image
        ...
        <p className="text-base text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur eligendi ea facere deleniti perspiciatis similique corrupti, nam voluptatem labore omnis!</p>
